...
<div id="content-outer"> 
  ...
  <div id="content"> 
    ...
    <!--  Nome da pagina -->
    <div id="page-heading">
      <h1> Controla Conteúdo multimídia </h1>
    </div>
    <!-- end page-heading -->
      ...
      <tr>
        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          ...
          <div id="table-content">
            ...
            <form action="../A3RA/midiaConsulta.php" method="post">
              ...
              <table width="340" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <th valign="top"><label for="txExt">Extensão:</label></th>
                  <td><input type="text" name="ext" id="txExt" class="inp-form" maxlength="100" /></td>
                  <td></td>
                </tr>
                <tr>
                  <th></th>
          ...
          <?php
			...
			include('banco.php'); 			
			if(!isset($_SESSION['arquivoDeletado'])){
				$_SESSION['arquivoDeletado']="";
			}
			if($_SESSION['arquivoDeletado']=="deletado"){
				mensagemVerde("Arquivo deletado");
				$_SESSION['arquivoDeletado']="";
			}
			...
			if(!empty($_POST)){
				...
				if ((empty($_POST['nome']) && empty($_POST['ext']))) {
					$dados = consultaArquivos();
				}else{
					$dados = consultaArquivosCampos("",$_POST['nome'],  $_POST['ext'],"");
				}
                    ...
                    echo "<th class=\"table-header-repeat line-left minwidth-1\"><a href=\"\">Local</a></th>";
                    echo "<th class=\"table-header-repeat line-left\"><a href=\"\">Extensão</a></th>";
					...
					foreach($dados as $linha){
						...
						echo "<form action=\"../A3RA/midiaModifica.php\" method=\"post\">
							  <input type=\"hidden\" name=\"id\" id=\"id\" value=\"".$linha['idARQUIVOS']."\"/>
						      <td><input type=\"hidden\" name=\"nome\" id=\"nome\" value=\"".$linha['nome']."\"/>".$linha['nome']."</td>
						      <td><input type=\"hidden\" name=\"endereco\" id=\"endereco\" value=\"" .$linha['endereco']."\"/>".$linha['endereco']."</td>
						      <td><input type=\"hidden\" name=\"extensao\" id=\"extensao\" value=\"" .$linha['extensao']."\"/>".$linha['extensao']."</td>
						      <td>		
								<input type=\"submit\" class=\"form-submit-icon-1\"></input>
								</form>		
								<form action=\"../A3RA/midiaDeleta.php\" method=\"post\">
									<input type=\"hidden\" name=\"id\" id=\"id\" value=\"".$linha['idARQUIVOS']."\"/>
									<input type=\"hidden\" name=\"nome\" id=\"nome\" value=\"".$linha['nome']."\"/>
									<input type=\"hidden\" name=\"endereco\" id=\"endereco\" value=\"" .$linha['endereco']."\"/>
									<input type=\"hidden\" name=\"extensao\" id=\"extensao\" value=\"" .$linha['extensao']."\"/>
