      ...
      <tr>
        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          ...
          <div id="table-content">
            ...
            <form action="../A3RA/marcadorConsulta.php" method="post">
              ...
              <table width="340" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <th valign="top"><label for="txExt">Target ID:</label></th>
                  <td><input type="text" name="targetID" id="targetID" class="inp-form" maxlength="100" /></td>
                  <td></td>
                </tr>
                <tr>
                  <th></th>
          ...
          <?php
			...
			if($_SESSION['marcadorDeletado']=="deletado"){
				mensagemVerde("Marcador deletado");
				$_SESSION['marcadorDeletado']="";
			}
			...
			if(!empty($_POST)){
				...
				if (empty($_POST['nome'])) {
					$dados = consultaMarcadores();
				}else{
					$dados = consultaMarcadoresCampos("", $_POST['nome'], "", "");
				}
                    ...
                    echo "<th class=\"table-header-repeat line-left minwidth-1\"><a href=\"\">TargetID</a></th>";
                    echo "<th class=\"table-header-repeat line-left\"><a href=\"\">Imagem</a></th>";
					...
					foreach($dados as $linha){
						if($cinza){
							...
							echo "<td><input type=\"hidden\" name=\"nome\" id=\"nome\" value=\"".$linha['nome']."\"/>".$linha['nome']."</td>
								  <td><input type=\"hidden\" name=\"targetID\" id=\"targetID\" value=\"" .$linha['targetID']."\"/>".$linha['targetID']."</td>
								  <td><img src=\"../A3RA/vuforiaweb/".$linha['nome']."\" width=\"60\" height=\"60\" /></td>
								  
								  <td>			
									<form action=\"../A3RA/marcadorDeleta.php\" method=\"post\">
										<input type=\"hidden\" name=\"id\" id=\"id\" value=\"".$linha['idMARCADORES']."\"/>
										<input type=\"hidden\" name=\"nome\" id=\"nome\" value=\"".$linha['nome']."\"/>
										<input type=\"hidden\" name=\"targetID\" id=\"targetID\" value=\"" .$linha['targetID']."\"/>
