...
<div id="page-heading"><h1>Modificação de Usuário</h1></div>
...
<?php
	...
	if(!empty($_POST['mod'])){
		...
		modificaUsuarios($_POST['nomeMod'], $_POST['usuarioMod'], $_POST['senhaMod'], $_POST['emailMod'], 
						$_POST['nivelMod'], $_POST['ativoMod'], $_POST['dataMod'],$_POST['obsTensa'], $_POST['grupoMod'],$_POST['idMod']);			
		$id = $_POST['idMod'];
		$nome = $_POST['nomeMod']; 
		...
		$dados = consultaUsuariosCampos($_POST['nome'], $_POST['usuario'], "",$_POST['email'], $_POST['grupo'],"");
        ...
        <div id="table-content">
              <table width="340" border="0" cellpadding="0" cellspacing="0">
                 <form action="../A3RA/usuarioModifica.php" method="post">
                  ...
                  <td>
                  	<select name="grupoMod" id="grupoMod" class="styledselect_form_1">
						 <?php										
                           $dados = consultaGrupos();
							//print_r ($dados);							
							foreach($dados as $linha) {
								if($linha['idGRUPOS'] == $grupo){
									echo "<option value=\"".$linha['idGRUPOS']."\"selected>".$linha['nome']."</option>";
								}else{
